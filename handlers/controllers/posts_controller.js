...
module.exports.index = (event, context, callback) => {
  ...
  var args = [
    ...
    "handlers/controllers/posts_controller.index" // IE: handlers/controllers/posts.update
  ]
...
module.exports.new = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/posts_controller.new" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.show = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/posts_controller.show" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.create = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/posts_controller.create" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.edit = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/posts_controller.edit" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.update = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/posts_controller.update" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.delete = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/posts_controller.delete" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
