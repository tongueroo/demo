...
module.exports.index = (event, context, callback) => {
  ...
  var args = [
    ...
    "handlers/controllers/stores_controller.index" // IE: handlers/controllers/posts.update
  ]
...
module.exports.new = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/stores_controller.new" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.show = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/stores_controller.show" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
