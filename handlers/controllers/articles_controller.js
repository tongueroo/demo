...
module.exports.index = (event, context, callback) => {
  // Command: bin/jets_wrapper process controller [event] [context] [handler]
  var args = [
    "process",
    "controller",     // controller (singular)
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.index" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.show = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.show" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.new = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.new" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.edit = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.edit" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.create = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.create" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.update = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.update" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
module.exports.delete = (event, context, callback) => {
  ...
  var args = [
    ...
    JSON.stringify(event),      // event
    JSON.stringify(context),    // context
    "handlers/controllers/articles_controller.delete" // IE: handlers/controllers/posts.update
  ]
  var ruby = spawn("bin/jets_wrapper", args);
...
if (process.platform == "darwin") {
  ...
  module.exports.index(event, context, (error, message) => {
